...
class AnalyticIncomeExpenseAdapter(
    context: Context,
    val listener: SingleItemCLickListener
  /*  var mTasksDataFiltered: MutableList<MyTaskItem>, val listener: SingleListCLickListener*/) : RecyclerView.Adapter<AnalyticIncomeExpenseAdapter.VHolder>() {
