...
class JobContractorUsersJobsDetailsAdapter(
    context: Context,
    val listener: SingleItemCLickListener
  /*  var mTasksDataFiltered: MutableList<MyTaskItem>, val listener: SingleListCLickListener*/) : RecyclerView.Adapter<JobContractorUsersJobsDetailsAdapter.VHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VHolder {
        return VHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.row_item_contractorusersupdatedusers, parent, false)
        )
    }

    override fun getItemCount(): Int = /*mTasksDataFiltered.size*/1
