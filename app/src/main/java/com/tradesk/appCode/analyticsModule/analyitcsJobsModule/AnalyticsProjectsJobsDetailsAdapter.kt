...
class AnalyticsProjectsJobsDetailsAdapter(
    context: Context,
    val listener: SingleItemCLickListener
  /*  var mTasksDataFiltered: MutableList<MyTaskItem>, val listener: SingleListCLickListener*/) : RecyclerView.Adapter<AnalyticsProjectsJobsDetailsAdapter.VHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VHolder {
        return VHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.row_item_jobsinvoicesanalytics, parent, false)
        )
    }
