...
class AnalyticsJobsDetailsPresenter<V : IAnalyticsJobsDetailsView>
@Inject internal constructor(private val mPrefs: AppPreferenceHelper, val cmp: CompositeDisposable, val apiHelpers: ApiHelper
) : BasePresenter<V>(mPrefs, compositeDisposable = cmp, apiHelper = apiHelpers), IAnalyticsJobsDetailsPresenter<V> {
