...
class AnalyticsProjectsProposalsDetailsAdapter(
    context: Context,
    val listener: SingleItemCLickListener
  /*  var mTasksDataFiltered: MutableList<MyTaskItem>, val listener: SingleListCLickListener*/) : RecyclerView.Adapter<AnalyticsProjectsProposalsDetailsAdapter.VHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VHolder {
        return VHolder(
            LayoutInflater.from(parent.context).inflate(R.layout.row_item_jobsproposalsanalytics , parent, false)
        )
    }
