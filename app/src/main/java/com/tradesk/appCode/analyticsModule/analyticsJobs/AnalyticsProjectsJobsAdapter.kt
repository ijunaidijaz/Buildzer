...
class AnalyticsProjectsJobsAdapter(
    context: Context,
    val listener: SingleItemCLickListener
  /*  var mTasksDataFiltered: MutableList<MyTaskItem>, val listener: SingleListCLickListener*/) : RecyclerView.Adapter<AnalyticsProjectsJobsAdapter.VHolder>() {
