    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VHolder {
        return VHolder(
            LayoutInflater.from(parent.context)
                .inflate(R.layout.row_item_comnpletedjobscontracts, parent, false)
        )
    }

    override fun getItemCount(): Int = /*mTasksDataFiltered.size*/2
