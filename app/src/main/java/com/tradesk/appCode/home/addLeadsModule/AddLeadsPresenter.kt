...
class AddLeadsPresenter<V : IAddLeadsView>
@Inject internal constructor(
    ...
    IAddLeadsPresenter<V> {

    fun add_leads(map: HashMap<String, RequestBody>, list: ArrayList<RequestBody?>?) {
        mvpView!!.showLoading()
        cmp.add(
    ...
    fun updateLeads(map: HashMap<String, RequestBody>, list: ArrayList<RequestBody?>?) {
        mvpView!!.showLoading()
        cmp.add(
