...
//        else makeItemDisabled(holder)
    ...
    private fun makeItemDisabled(holder: ViewHolder) {
        holder.txtDay!!.setTextColor(ContextCompat.getColor(context, R.color.text_color))
        holder.txtDayInWeek!!.setTextColor(ContextCompat.getColor(context, R.color.black_color))
    ...
    private fun makeItemSelected(holder: ViewHolder) {
        ...
        holder.linearLayout!!.setBackgroundResource(R.drawable.ic_oramgeround)
        holder.linearLayout!!.isEnabled = false
    }
