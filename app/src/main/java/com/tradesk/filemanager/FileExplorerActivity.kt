        ...
        if (hasPermission) {
            if (Build.VERSION.SDK_INT == Build.VERSION_CODES.Q) {
                if (!Environment.isExternalStorageLegacy()) {
                    ...
                    legacyStorageView.visibility = View.VISIBLE
                    return
                }
            }

            rationaleView.visibility = View.GONE
            filesTreeView.visibility = View.VISIBLE
            ...
            filesTreeView.visibility = View.GONE
        }
    }
...
//        }
        ...
        filesTreeView.adapter = adapter
        filesTreeView.setOnItemClickListener { _, _, position, _ ->
