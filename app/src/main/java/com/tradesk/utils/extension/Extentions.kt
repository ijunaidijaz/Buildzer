...
import com.tradesk.BuildzerApp.Companion.ON_CLICK_DELAY
import com.tradesk.BuildzerApp.Companion.lastTimeClicked
...
//    TSnackbar.make(findViewById(android.R.id.content),message!!,TSnackbar.LENGTH_SHORT).show()


    TBSnackbar.make(
        findViewById(android.R.id.content),
        message!!,
        TBSnackbar.LENGTH_LONG,
        TBSnackbar.STYLE_SHOW_TOP
    ).show()
